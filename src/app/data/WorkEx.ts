export const workExperience = [
  ...
  {
    id: 2,
    title: "Joint Technical Head - CSI TSEC",
    desc: "Led the development and deployment of the CSI TSEC website from scratch using React.js, while guiding junior team members to collaborate effectively.",
    className: "md:col-span-2",
    thumbnail: "/exp3.svg",
  },
  {
