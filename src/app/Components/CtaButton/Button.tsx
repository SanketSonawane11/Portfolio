...
const CtaButton: React.FC<CtaButtonProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="px-8 py-2 text-sm md:text-md lg:text-lg bg-black rounded-2xl relative group duration-200 text-white hover:bg-transparent active:bg-black flex items-center justify-center gap-2 transition-all ease-out hover:text-[1rem]">
